---
description: Generate detailed Routing Resolution Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete routing resolution flow.

## Output Location

Write to: `docs/flows/routing.md`
