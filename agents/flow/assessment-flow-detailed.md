---
description: Generate detailed Assessment Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete assessment flow.

## Output Location

Write to: `docs/flows/assessment.md`
