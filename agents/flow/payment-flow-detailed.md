---
description: Generate detailed Payment Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete payment flow.

## Output Location

Write to: `docs/flows/payment.md`
