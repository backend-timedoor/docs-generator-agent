---
description: Generate detailed Logging Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete logging flow.

## Output Location

Write to: `docs/flows/logging.md`
