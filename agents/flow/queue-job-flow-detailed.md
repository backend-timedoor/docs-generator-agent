---
description: Generate detailed Queue Job Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete queue job flow.

## Output Location

Write to: `docs/flows/queue-jobs.md`
