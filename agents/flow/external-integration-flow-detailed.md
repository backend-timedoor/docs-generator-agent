---
description: Generate detailed External Integration Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete external integration flow.

## Output Location

Write to: `docs/flows/external-integrations.md`
