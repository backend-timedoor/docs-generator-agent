---
description: Generate detailed Exception Handling Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete exception handling flow.

## Output Location

Write to: `docs/flows/exceptions.md`
