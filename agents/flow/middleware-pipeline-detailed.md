---
description: Generate detailed Middleware Pipeline Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete middleware pipeline flow.

## Output Location

Write to: `docs/flows/middleware-pipeline.md`
