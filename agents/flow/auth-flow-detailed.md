---
description: Generate detailed Authentication Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete authentication flow.

## Output Location

Write to: `docs/flows/authentication.md`
