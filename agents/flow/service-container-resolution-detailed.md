---
description: Generate detailed Service Container Resolution Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete service container resolution flow.

## Output Location

Write to: `docs/flows/service-container.md`
