---
description: Generate detailed Soft Delete Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete soft delete flow.

## Output Location

Write to: `docs/flows/soft-deletes.md`
