---
description: Generate detailed Database Transaction Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete database transaction flow.

## Output Location

Write to: `docs/flows/database-transactions.md`
