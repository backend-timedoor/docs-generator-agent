---
description: Generate detailed Model Observer Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete model observer flow.

## Output Location

Write to: `docs/flows/model-observers.md`
