---
description: Generate detailed Role & Permission Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete role & permission flow.

## Output Location

Write to: `docs/flows/role-permission.md`
