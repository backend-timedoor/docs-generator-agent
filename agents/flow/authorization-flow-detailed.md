---
description: Generate detailed Authorization Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete authorization flow.

## Output Location

Write to: `docs/flows/authorization.md`
