---
description: Generate detailed Model Lifecycle Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete model lifecycle flow.

## Output Location

Write to: `docs/flows/model-lifecycle.md`
