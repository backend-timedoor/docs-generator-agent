---
description: Generate detailed Scheduled Tasks Flow documentation for Laravel projects
model: inherit
tools: Write, Read, Grep
---

Trace and document the complete scheduled tasks flow.

## Output Location

Write to: `docs/flows/scheduled-tasks.md`
